const PrivacyPolicy = () => {
  return (
    <div>
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            this Agreement) refers to MaverickCER, 1 MaverickCER, Florida,.
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to Callouts Evolved, accessible from{" "}
            <a
              href="https://www.calloutsevolved.com"
              rel="external nofollow noopener noreferrer"
              target="_blank"
            >
              https://www.calloutsevolved.com
            </a>
          </p>
        </li>
        <li>
      ...
      <ul>
        <li>By email: MaverickCER@gmail.com</li>
      </ul>
    </div>
  );
};
