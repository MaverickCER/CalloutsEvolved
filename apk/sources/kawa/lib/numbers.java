...
public class numbers extends ModuleBody {
    ...
    static {
        ...
        number$Qu = new ModuleMethod(numbers, 1, Lit3, 4097);
        quantity$Qu = new ModuleMethod(numbers, 2, Lit4, 4097);
        complex$Qu = new ModuleMethod(numbers, 3, Lit5, 4097);
        real$Qu = new ModuleMethod(numbers, 4, Lit6, 4097);
        rational$Qu = new ModuleMethod(numbers, 5, Lit7, 4097);
        integer$Qu = new ModuleMethod(numbers, 6, Lit8, 4097);
        exact$Qu = new ModuleMethod(numbers, 7, Lit9, 4097);
        inexact$Qu = new ModuleMethod(numbers, 8, Lit10, 4097);
        zero$Qu = new ModuleMethod(numbers, 9, Lit11, 4097);
        positive$Qu = new ModuleMethod(numbers, 10, Lit12, 4097);
        negative$Qu = new ModuleMethod(numbers, 11, Lit13, 4097);
        max = new ModuleMethod(numbers, 12, Lit14, -4096);
        min = new ModuleMethod(numbers, 13, Lit15, -4096);
        abs = new ModuleMethod(numbers, 14, Lit16, 4097);
        ...
        numerator = new ModuleMethod(numbers, 19, Lit21, 4097);
        denominator = new ModuleMethod(numbers, 20, Lit22, 4097);
        floor = new ModuleMethod(numbers, 21, Lit23, 4097);
        ceiling = new ModuleMethod(numbers, 22, Lit24, 4097);
        truncate = new ModuleMethod(numbers, 23, Lit25, 4097);
        round = new ModuleMethod(numbers, 24, Lit26, 4097);
        rationalize = new ModuleMethod(numbers, 25, Lit27, 8194);
        exp = new ModuleMethod(numbers, 26, Lit28, 4097);
        log = new ModuleMethod(numbers, 27, Lit29, 4097);
        sin = new ModuleMethod(numbers, 28, Lit30, 4097);
        cos = new ModuleMethod(numbers, 29, Lit31, 4097);
        tan = new ModuleMethod(numbers, 30, Lit32, 4097);
        asin = new ModuleMethod(numbers, 31, Lit33, 4097);
        acos = new ModuleMethod(numbers, 32, Lit34, 4097);
        ...
        ModuleMethod moduleMethod2 = new ModuleMethod(numbers, 34, (Object) null, 4097);
        moduleMethod2.setProperty("source-location", "/Users/ewpatton/Programming/mit/ai2-kawa/kawa/lib/numbers.scm:148");
        lambda$Fn2 = moduleMethod2;
        ModuleMethod moduleMethod3 = new ModuleMethod(numbers, 35, (Object) null, 4097);
        moduleMethod3.setProperty("source-location", "/Users/ewpatton/Programming/mit/ai2-kawa/kawa/lib/numbers.scm:152");
        lambda$Fn3 = moduleMethod3;
        ModuleMethod moduleMethod4 = new ModuleMethod(numbers, 36, (Object) null, 4097);
        moduleMethod4.setProperty("source-location", "/Users/ewpatton/Programming/mit/ai2-kawa/kawa/lib/numbers.scm:156");
        ...
        real$Mnpart = new ModuleMethod(numbers, 39, Lit37, 4097);
        imag$Mnpart = new ModuleMethod(numbers, 40, Lit38, 4097);
        magnitude = new ModuleMethod(numbers, 41, Lit39, 4097);
        angle = new ModuleMethod(numbers, 42, Lit40, 4097);
        inexact = new ModuleMethod(numbers, 43, Lit41, 4097);
        exact = new ModuleMethod(numbers, 44, Lit42, 4097);
        exact$Mn$Grinexact = new ModuleMethod(numbers, 45, Lit43, 4097);
        inexact$Mn$Grexact = new ModuleMethod(numbers, 46, Lit44, 4097);
        ...
        logcount = new ModuleMethod(numbers, 54, Lit52, 4097);
        bitwise$Mnbit$Mncount = new ModuleMethod(numbers, 55, Lit53, 4097);
        bitwise$Mnlength = new ModuleMethod(numbers, 56, Lit54, 4097);
        bitwise$Mnfirst$Mnbit$Mnset = new ModuleMethod(numbers, 57, Lit55, 4097);
        ...
        quantity$Mn$Grnumber = new ModuleMethod(numbers, 64, Lit60, 4097);
        quantity$Mn$Grunit = new ModuleMethod(numbers, 65, Lit61, 4097);
        make$Mnquantity = new ModuleMethod(numbers, 66, Lit62, 8194);
        duration = new ModuleMethod(numbers, 67, Lit63, 4097);
        $instance.run();
    }
    ...
    public int match1(ModuleMethod moduleMethod, Object obj, CallContext callContext) {
        switch (moduleMethod.selector) {
            ...
            case 41:
                ...
                callContext.f201pc = 1;
                return 0;
            case XDataType.NMTOKEN_TYPE_CODE:
                if (!(obj instanceof Complex)) {
                    return -786431;
                }
                callContext.value1 = obj;
            ...
            case XDataType.NAME_TYPE_CODE:
                ...
                callContext.f201pc = 1;
                return 0;
            case XDataType.NCNAME_TYPE_CODE:
                if (!(obj instanceof Number)) {
                    return -786431;
                }
                callContext.value1 = obj;
            ...
            case XDataType.ID_TYPE_CODE:
                ...
                callContext.f201pc = 1;
                return 0;
            case XDataType.IDREF_TYPE_CODE:
                if (!(obj instanceof Number)) {
                    return -786431;
                }
                callContext.value1 = obj;
    ...
    public int match3(ModuleMethod moduleMethod, Object obj, Object obj2, Object obj3, CallContext callContext) {
        switch (moduleMethod.selector) {
            case XDataType.ENTITY_TYPE_CODE:
                callContext.value1 = obj;
                if (IntNum.asIntNumOrNull(obj2) == null) {
                    return -786430;
                }
