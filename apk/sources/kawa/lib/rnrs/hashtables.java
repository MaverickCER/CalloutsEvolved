...
public class hashtables extends ModuleBody {
    ...
    static {
        ...
        hash$Mnby$Mnidentity = new ModuleMethod(hashtables, 1, Lit0, 4097);
        hash$Mnfor$Mneqv = new ModuleMethod(hashtables, 2, Lit1, 4097);
        ...
        hashtable$Qu = new ModuleMethod(hashtables, 9, Lit5, 4097);
        hashtable$Mnsize = new ModuleMethod(hashtables, 10, Lit6, 4097);
        ...
        hashtable$Mnkeys = new ModuleMethod(hashtables, 20, Lit14, 4097);
        hashtable$Mnentries = new ModuleMethod(hashtables, 21, Lit15, 4097);
        hashtable$Mnequivalence$Mnfunction = new ModuleMethod(hashtables, 22, Lit16, 4097);
        hashtable$Mnhash$Mnfunction = new ModuleMethod(hashtables, 23, Lit17, 4097);
        hashtable$Mnmutable$Qu = new ModuleMethod(hashtables, 24, Lit18, 4097);
        equal$Mnhash = new ModuleMethod(hashtables, 25, Lit19, 4097);
        string$Mnhash = new ModuleMethod(hashtables, 26, Lit20, 4097);
        string$Mnci$Mnhash = new ModuleMethod(hashtables, 27, Lit21, 4097);
        symbol$Mnhash = new ModuleMethod(hashtables, 28, Lit22, 4097);
        $instance.run();
    }
