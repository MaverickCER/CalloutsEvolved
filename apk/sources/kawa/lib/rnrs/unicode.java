...
public class unicode extends ModuleBody {
    ...
    static {
        ...
        char$Mnupcase = new ModuleMethod(unicode, 1, Lit0, 4097);
        char$Mndowncase = new ModuleMethod(unicode, 2, Lit1, 4097);
        char$Mntitlecase = new ModuleMethod(unicode, 3, Lit2, 4097);
        char$Mnalphabetic$Qu = new ModuleMethod(unicode, 4, Lit3, 4097);
        char$Mnnumeric$Qu = new ModuleMethod(unicode, 5, Lit4, 4097);
        char$Mnwhitespace$Qu = new ModuleMethod(unicode, 6, Lit5, 4097);
        char$Mnupper$Mncase$Qu = new ModuleMethod(unicode, 7, Lit6, 4097);
        char$Mnlower$Mncase$Qu = new ModuleMethod(unicode, 8, Lit7, 4097);
        char$Mntitle$Mncase$Qu = new ModuleMethod(unicode, 9, Lit8, 4097);
        char$Mnfoldcase = new ModuleMethod(unicode, 10, Lit9, 4097);
        ...
        char$Mngeneral$Mncategory = new ModuleMethod(unicode, 16, Lit15, 4097);
        string$Mnupcase = new ModuleMethod(unicode, 17, Lit16, 4097);
        string$Mndowncase = new ModuleMethod(unicode, 18, Lit17, 4097);
        string$Mntitlecase = new ModuleMethod(unicode, 19, Lit18, 4097);
        string$Mnfoldcase = new ModuleMethod(unicode, 20, Lit19, 4097);
        ...
        string$Mnnormalize$Mnnfd = new ModuleMethod(unicode, 26, Lit25, 4097);
        string$Mnnormalize$Mnnfkd = new ModuleMethod(unicode, 27, Lit26, 4097);
        string$Mnnormalize$Mnnfc = new ModuleMethod(unicode, 28, Lit27, 4097);
        string$Mnnormalize$Mnnfkc = new ModuleMethod(unicode, 29, Lit28, 4097);
        $instance.run();
    }
