...
public class prim_syntax extends ModuleBody {
    ...
    /* renamed from: if */
    public static final Macro f225if;
    ...
    static {
        ...
        ModuleMethod moduleMethod = new ModuleMethod(prim_syntax, 2, (Object) null, 4097);
        moduleMethod.setProperty("source-location", "/Users/ewpatton/Programming/mit/ai2-kawa/kawa/lib/prim_syntax.scm:69");
        f225if = Macro.make(simpleSymbol7, moduleMethod, $instance);
        SimpleSymbol simpleSymbol8 = Lit25;
        ModuleMethod moduleMethod2 = new ModuleMethod(prim_syntax, 3, (Object) null, 4097);
        ...
        ModuleMethod moduleMethod3 = new ModuleMethod(prim_syntax, 4, (Object) null, 4097);
