...
public class vectors extends ModuleBody {
    ...
    static {
        ...
        vector$Qu = new ModuleMethod(vectors, 1, Lit1, 4097);
        make$Mnvector = new ModuleMethod(vectors, 2, Lit2, 8193);
        vector$Mnlength = new ModuleMethod(vectors, 4, Lit3, 4097);
        vector$Mnset$Ex = new ModuleMethod(vectors, 5, Lit4, 12291);
        vector$Mnref$Fn1 = new ModuleMethod(vectors, 6, Lit5, 8194);
        vector$Mn$Grlist = new ModuleMethod(vectors, 7, Lit6, 4097);
        list$Mn$Grvector = new ModuleMethod(vectors, 8, Lit7, 4097);
    ...
    public static LList vector$To$List(FVector vec) {
        ...
        while (true) {
            ...
            result = C0214lists.cons(vector$Mnref.apply2(vec, Integer.valueOf(i)), result);
        }
    }
