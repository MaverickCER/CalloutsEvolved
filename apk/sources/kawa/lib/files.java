...
public class files extends ModuleBody {
    ...
    static {
        ...
        path$Qu = new ModuleMethod(files, 1, Lit0, 4097);
        filepath$Qu = new ModuleMethod(files, 2, Lit1, 4097);
        URI$Qu = new ModuleMethod(files, 3, Lit2, 4097);
        absolute$Mnpath$Qu = new ModuleMethod(files, 4, Lit3, 4097);
        path$Mnscheme = new ModuleMethod(files, 5, Lit4, 4097);
        path$Mnauthority = new ModuleMethod(files, 6, Lit5, 4097);
        path$Mnuser$Mninfo = new ModuleMethod(files, 7, Lit6, 4097);
        path$Mnhost = new ModuleMethod(files, 8, Lit7, 4097);
        path$Mnfile = new ModuleMethod(files, 9, Lit8, 4097);
        path$Mndirectory = new ModuleMethod(files, 10, Lit9, 4097);
        path$Mnparent = new ModuleMethod(files, 11, Lit10, 4097);
        path$Mnlast = new ModuleMethod(files, 12, Lit11, 4097);
        path$Mnextension = new ModuleMethod(files, 13, Lit12, 4097);
        path$Mnport = new ModuleMethod(files, 14, Lit13, 4097);
        path$Mnquery = new ModuleMethod(files, 15, Lit14, 4097);
        path$Mnfragment = new ModuleMethod(files, 16, Lit15, 4097);
        file$Mnexists$Qu = new ModuleMethod(files, 17, Lit16, 4097);
        file$Mndirectory$Qu = new ModuleMethod(files, 18, Lit17, 4097);
        file$Mnreadable$Qu = new ModuleMethod(files, 19, Lit18, 4097);
        file$Mnwritable$Qu = new ModuleMethod(files, 20, Lit19, 4097);
        delete$Mnfile = new ModuleMethod(files, 21, Lit20, 4097);
        rename$Mnfile = new ModuleMethod(files, 22, Lit21, 8194);
        copy$Mnfile = new ModuleMethod(files, 23, Lit22, 8194);
        create$Mndirectory = new ModuleMethod(files, 24, Lit23, 4097);
        directory$Mnfiles = new ModuleMethod(files, 25, Lit24, 4097);
        $Mn$Grpathname = new ModuleMethod(files, 26, Lit25, 4097);
