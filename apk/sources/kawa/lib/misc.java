...
public class misc extends ModuleBody {
    ...
    static {
        misc misc = $instance;
        boolean$Qu = new ModuleMethod(misc, 3, Lit4, 4097);
        symbol$Qu = new ModuleMethod(misc, 4, Lit5, 4097);
        symbol$Mn$Grstring = new ModuleMethod(misc, 5, Lit6, 4097);
        ...
        moduleMethod2.setProperty("source-location", "/Users/ewpatton/Programming/mit/ai2-kawa/kawa/lib/misc.scm:27");
        lambda$Fn2 = moduleMethod2;
        symbol$Mnlocal$Mnname = new ModuleMethod(misc, 8, Lit7, 4097);
        symbol$Mnnamespace = new ModuleMethod(misc, 9, Lit8, 4097);
        symbol$Mnnamespace$Mnuri = new ModuleMethod(misc, 10, Lit9, 4097);
        symbol$Mnprefix = new ModuleMethod(misc, 11, Lit10, 4097);
        namespace$Mnuri = new ModuleMethod(misc, 12, Lit11, 4097);
        namespace$Mnprefix = new ModuleMethod(misc, 13, Lit12, 4097);
        string$Mn$Grsymbol = new ModuleMethod(misc, 14, Lit13, 4097);
        procedure$Qu = new ModuleMethod(misc, 15, Lit14, 4097);
        ...
        scheme$Mnreport$Mnenvironment = new ModuleMethod(misc, 20, Lit18, 4097);
        ...
        force = new ModuleMethod(misc, 27, Lit24, 4097);
