...
public class keywords extends ModuleBody {
    ...
    static {
        ...
        keyword$Qu = new ModuleMethod(keywords, 1, Lit0, 4097);
        keyword$Mn$Grstring = new ModuleMethod(keywords, 2, Lit1, 4097);
        string$Mn$Grkeyword = new ModuleMethod(keywords, 3, Lit2, 4097);
        $instance.run();
    }
