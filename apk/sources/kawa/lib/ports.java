...
public class ports extends ModuleBody {
    ...
    static {
        ...
        open$Mninput$Mnfile = new ModuleMethod(ports, 1, Lit10, 4097);
        open$Mnoutput$Mnfile = new ModuleMethod(ports, 2, Lit11, 4097);
        ...
        input$Mnport$Qu = new ModuleMethod(ports, 7, Lit16, 4097);
        output$Mnport$Qu = new ModuleMethod(ports, 8, Lit17, 4097);
        lambda$Fn1 = new ModuleMethod(ports, 9, (Object) null, 4097);
        lambda$Fn2 = new ModuleMethod(ports, 10, (Object) null, 4097);
        lambda$Fn3 = new ModuleMethod(ports, 11, (Object) null, 4097);
        write$Mnchar = new ModuleMethod(ports, 12, Lit18, 8193);
        open$Mninput$Mnstring = new ModuleMethod(ports, 14, Lit19, 4097);
        open$Mnoutput$Mnstring = new ModuleMethod(ports, 15, Lit20, 0);
        get$Mnoutput$Mnstring = new ModuleMethod(ports, 16, Lit21, 4097);
        call$Mnwith$Mninput$Mnstring = new ModuleMethod(ports, 17, Lit22, 8194);
        call$Mnwith$Mnoutput$Mnstring = new ModuleMethod(ports, 18, Lit23, 4097);
        force$Mnoutput = new ModuleMethod(ports, 19, Lit24, 4096);
        newline = new ModuleMethod(ports, 21, Lit25, 4096);
        eof$Mnobject$Qu = new ModuleMethod(ports, 23, Lit26, 4097);
        ...
        input$Mnport$Mnread$Mnstate = new ModuleMethod(ports, 30, Lit30, 4097);
        set$Mnport$Mnline$Ex = new ModuleMethod(ports, 31, Lit31, 8194);
        port$Mnline$Fn4 = new ModuleMethod(ports, 32, Lit32, 4097);
        set$Mninput$Mnport$Mnline$Mnnumber$Ex = new ModuleMethod(ports, 33, Lit33, 8194);
        input$Mnport$Mnline$Mnnumber$Fn5 = new ModuleMethod(ports, 34, Lit34, 4097);
        port$Mncolumn = new ModuleMethod(ports, 35, Lit35, 4097);
        input$Mnport$Mncolumn$Mnnumber = new ModuleMethod(ports, 36, Lit36, 4097);
        default$Mnprompter = new ModuleMethod(ports, 37, Lit37, 4097);
        set$Mninput$Mnport$Mnprompter$Ex = new ModuleMethod(ports, 38, Lit38, 8194);
        input$Mnport$Mnprompter$Fn6 = new ModuleMethod(ports, 39, Lit39, 4097);
        close$Mninput$Mnport = new ModuleMethod(ports, 40, Lit40, 4097);
        close$Mnoutput$Mnport = new ModuleMethod(ports, 41, Lit41, 4097);
        read = new ModuleMethod(ports, 42, Lit42, 4096);
        read$Mnline = new ModuleMethod(ports, 44, Lit43, 8192);
        transcript$Mnon = new ModuleMethod(ports, 47, Lit44, 4097);
