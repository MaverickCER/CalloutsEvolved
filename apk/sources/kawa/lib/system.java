...
public class system extends ModuleBody {
    ...
    public static final ModuleMethod f235catch;
    ...
    static {
        ...
        f235catch = new ModuleMethod(system2, 9, Lit10, 12291);
    ...
    public static Process makeProcess(Object args, Object env) {
        ...
        } else if (C0214lists.isList(args)) {
    ...
    public static Object convertListToStringArray(Object lst) {
        try {
            String[] arr = new String[C0214lists.length((LList) lst)];
            int i = 0;
            Object p = lst;
            while (!C0214lists.isNull(p)) {
                try {
                    Pair pp = (Pair) p;
    ...
    public static Object tokenizeStringToStringArray(String string) {
        ...
        while (toks.hasMoreTokens()) {
            lList = C0214lists.cons(toks.nextToken(), lList);
        }
        try {
            int count = C0214lists.length(lList);
            String[] arr = new String[count];
            int i = count - 1;
            Object p = lList;
            while (!C0214lists.isNull(p)) {
            ...
            throw new WrongType(e2, "length", 1, (Object) lList);
        }
    }
