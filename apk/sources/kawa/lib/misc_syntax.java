...
public class misc_syntax extends ModuleBody {
    ...
    static {
        ...
        ModuleMethod moduleMethod2 = new ModuleMethod(misc_syntax, 3, (Object) null, 4097);
        moduleMethod2.setProperty("source-location", "/Users/ewpatton/Programming/mit/ai2-kawa/kawa/lib/misc_syntax.scm:54");
        include = Macro.make(simpleSymbol7, moduleMethod2, $instance);
        include$Mnrelative = Macro.make(Lit18, new ModuleMethod(misc_syntax, 4, (Object) null, 4097), $instance);
        $instance.run();
    }
    ...
    static Object lambda1(Object form) {
        ...
        if (Lit1.match(form, allocVars, 0)) {
            ...
            try {
                ...
                return C0214lists.cons(execute, C0214lists.cons(std_syntax.datum$To$SyntaxObject(form, misc.string$To$Symbol(strings.stringAppend(objArr2))), Lit4.execute(allocVars, TemplateScope.make())));
    ...
    static Object lambda3(Object x) {
        ...
        frame2.f223k = execute;
        try {
            frame2.f224p = ports.openInputFile(Path.valueOf(fn));
    ...
    public class frame extends ModuleBody {
        ...
        public Object lambda4f() {
            Object x = ports.read(this.f224p);
            if (!ports.isEofObject(x)) {
                return new Pair(std_syntax.datum$To$SyntaxObject(this.f223k, x), lambda4f());
            }
            ports.closeInputPort(this.f224p);
            return LList.Empty;
        }
    }
