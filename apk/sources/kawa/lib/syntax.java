...
public class syntax extends ModuleBody {
    ...
    public static final Macro f233import = Macro.make(Lit36, Lit37, $instance);
    ...
    public static final Macro f234synchronized;
    ...
    static {
        ...
        Lit36 = simpleSymbol7;
        Lit37 = new SyntaxRules(new Object[]{simpleSymbol7}, new SyntaxRule[]{new SyntaxRule(new SyntaxPattern("\f\u0018\r\u0007\u0000\b\b", new Object[0], 1), "\u0003", "\u0011\u0018\u0004\b\u0005\u0011\u0018\f\t\u0003\u0018\u0014", new Object[]{Lit110, Lit38, PairWithPosition.make(LList.Empty, LList.Empty, "/Users/ewpatton/Programming/mit/ai2-kawa/kawa/lib/syntax.scm", 376866)}, 1)}, 1);
        ...
        try$Mnfinally = Macro.make(simpleSymbol12, new ModuleMethod(syntax, 2, (Object) null, 4097), $instance);
        f234synchronized = Macro.make(Lit25, new ModuleMethod(syntax, 3, (Object) null, 4097), $instance);
        identifier$Mnlist$Qu = new ModuleMethod(syntax, 4, Lit29, 4097);
        identifier$Mnpair$Mnlist$Qu = new ModuleMethod(syntax, 5, Lit30, 4097);
        ...
        import$Mnmapper = new ModuleMethod(syntax, 10, Lit35, 4097);
        $Pcimport = Macro.make(Lit38, new ModuleMethod(syntax, 11, (Object) null, 4097), $instance);
        case$Mnlambda = Macro.make(Lit81, new ModuleMethod(syntax, 12, (Object) null, 4097), $instance);
        SimpleSymbol simpleSymbol13 = Lit93;
        ModuleMethod moduleMethod = new ModuleMethod(syntax, 13, (Object) null, 4097);
    ...
    public static Object importHandleOnly(Object name, Object list) {
        if (C0214lists.memq(name, list) != Boolean.FALSE) {
            return name;
        }
        return null;
    }
    ...
    public static Object importHandleRename(Object name, Object rename$Mnpairs) {
        if (!C0214lists.isPair(rename$Mnpairs)) {
            return name;
        }
        if (name == C0214lists.caar.apply1(rename$Mnpairs)) {
            return C0214lists.cadar.apply1(rename$Mnpairs);
        }
        return importHandleRename(name, C0214lists.cdr.apply1(rename$Mnpairs));
    }
    ...
    public class frame extends ModuleBody {
        ...
        public frame() {
            ModuleMethod moduleMethod = new ModuleMethod(this, 1, (Object) null, 4097);
        ...
        public Object lambda1(Object name) {
            ...
            while (true) {
                ...
                if (!x) {
                    ...
                    Object l2 = C0214lists.cdr.apply1(l);
                    name = Scheme.applyToArgs.apply3(C0214lists.caar.apply1(l), name, C0214lists.cdar.apply1(l));
                    l = l2;
                } else if (x) {
                    break;
                } else {
                    Object l22 = C0214lists.cdr.apply1(l);
                    name = Scheme.applyToArgs.apply3(C0214lists.caar.apply1(l), name, C0214lists.cdar.apply1(l));
                    l = l22;
                }
            }
    ...
    static Object lambda4(Object form) {
        ...
        if (Lit39.match(form, allocVars, 0)) {
            if (isIdentifierPairList(Lit40.execute(allocVars, TemplateScope.make()))) {
                ...
                return Quote.append$V(new Object[]{Lit41.execute(allocVars, make), Quote.consX$V(new Object[]{C0214lists.cons(C0214lists.cons(import$Mnhandle$Mnrename, Lit42.execute(allocVars, make)), Lit43.execute(allocVars, make)), Lit44.execute(allocVars, make)})});
            }
            ...
            if (isIdentifierList(Lit47.execute(allocVars, TemplateScope.make()))) {
                ...
                return Quote.append$V(new Object[]{Lit48.execute(allocVars, make2), Quote.consX$V(new Object[]{C0214lists.cons(C0214lists.cons(import$Mnhandle$Mnonly, Lit49.execute(allocVars, make2)), Lit50.execute(allocVars, make2)), Lit51.execute(allocVars, make2)})});
            }
            ...
            if (isIdentifierList(Lit54.execute(allocVars, TemplateScope.make()))) {
                ...
                return Quote.append$V(new Object[]{Lit55.execute(allocVars, make3), Quote.consX$V(new Object[]{C0214lists.cons(C0214lists.cons(import$Mnhandle$Mnexcept, Lit56.execute(allocVars, make3)), Lit57.execute(allocVars, make3)), Lit58.execute(allocVars, make3)})});
            }
            ...
            return Quote.append$V(new Object[]{Lit61.execute(allocVars, make4), Quote.consX$V(new Object[]{C0214lists.cons(C0214lists.cons(import$Mnhandle$Mnprefix, Lit62.execute(allocVars, make4)), Lit63.execute(allocVars, make4)), Lit64.execute(allocVars, make4)})});
