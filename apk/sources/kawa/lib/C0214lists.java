...
public class C0214lists extends ModuleBody {
    ...
    static {
        C0214lists lists = $instance;
        pair$Qu = new ModuleMethod(lists, 1, Lit3, 4097);
        cons = new ModuleMethod(lists, 2, Lit4, 8194);
        null$Qu = new ModuleMethod(lists, 3, Lit5, 4097);
        set$Mncar$Ex = new ModuleMethod(lists, 4, Lit6, 8194);
        set$Mncdr$Ex = new ModuleMethod(lists, 5, Lit7, 8194);
        ModuleMethod moduleMethod = new ModuleMethod(lists, 6, "car", 4097);
        ...
        ModuleMethod moduleMethod2 = new ModuleMethod(lists, 7, "cdr", 4097);
        moduleMethod2.setProperty("source-location", "/Users/ewpatton/Programming/mit/ai2-kawa/kawa/lib/lists.scm:36");
        cdr$Fn2 = moduleMethod2;
        lambda$Fn3 = new ModuleMethod(lists, 8, (Object) null, 8194);
        caar$Fn4 = new ModuleMethod(lists, 9, "caar", 4097);
        lambda$Fn5 = new ModuleMethod(lists, 10, (Object) null, 8194);
        cadr$Fn6 = new ModuleMethod(lists, 11, "cadr", 4097);
        lambda$Fn7 = new ModuleMethod(lists, 12, (Object) null, 8194);
        cdar$Fn8 = new ModuleMethod(lists, 13, "cdar", 4097);
        lambda$Fn9 = new ModuleMethod(lists, 14, (Object) null, 8194);
        cddr$Fn10 = new ModuleMethod(lists, 15, "cddr", 4097);
        lambda$Fn11 = new ModuleMethod(lists, 16, (Object) null, 8194);
        caaar$Fn12 = new ModuleMethod(lists, 17, "caaar", 4097);
        lambda$Fn13 = new ModuleMethod(lists, 18, (Object) null, 8194);
        caadr$Fn14 = new ModuleMethod(lists, 19, "caadr", 4097);
        lambda$Fn15 = new ModuleMethod(lists, 20, (Object) null, 8194);
        cadar$Fn16 = new ModuleMethod(lists, 21, "cadar", 4097);
        lambda$Fn17 = new ModuleMethod(lists, 22, (Object) null, 8194);
        caddr$Fn18 = new ModuleMethod(lists, 23, "caddr", 4097);
        lambda$Fn19 = new ModuleMethod(lists, 24, (Object) null, 8194);
        cdaar$Fn20 = new ModuleMethod(lists, 25, "cdaar", 4097);
        lambda$Fn21 = new ModuleMethod(lists, 26, (Object) null, 8194);
        cdadr$Fn22 = new ModuleMethod(lists, 27, "cdadr", 4097);
        lambda$Fn23 = new ModuleMethod(lists, 28, (Object) null, 8194);
        cddar$Fn24 = new ModuleMethod(lists, 29, "cddar", 4097);
        lambda$Fn25 = new ModuleMethod(lists, 30, (Object) null, 8194);
        cdddr$Fn26 = new ModuleMethod(lists, 31, "cdddr", 4097);
        lambda$Fn27 = new ModuleMethod(lists, 32, (Object) null, 8194);
        caaaar$Fn28 = new ModuleMethod(lists, 33, "caaaar", 4097);
        lambda$Fn29 = new ModuleMethod(lists, 34, (Object) null, 8194);
        caaadr$Fn30 = new ModuleMethod(lists, 35, "caaadr", 4097);
        lambda$Fn31 = new ModuleMethod(lists, 36, (Object) null, 8194);
        caadar$Fn32 = new ModuleMethod(lists, 37, "caadar", 4097);
        lambda$Fn33 = new ModuleMethod(lists, 38, (Object) null, 8194);
        caaddr$Fn34 = new ModuleMethod(lists, 39, "caaddr", 4097);
        lambda$Fn35 = new ModuleMethod(lists, 40, (Object) null, 8194);
        cadaar$Fn36 = new ModuleMethod(lists, 41, "cadaar", 4097);
        lambda$Fn37 = new ModuleMethod(lists, 42, (Object) null, 8194);
        cadadr$Fn38 = new ModuleMethod(lists, 43, "cadadr", 4097);
        lambda$Fn39 = new ModuleMethod(lists, 44, (Object) null, 8194);
        caddar$Fn40 = new ModuleMethod(lists, 45, "caddar", 4097);
        lambda$Fn41 = new ModuleMethod(lists, 46, (Object) null, 8194);
        cadddr$Fn42 = new ModuleMethod(lists, 47, "cadddr", 4097);
        lambda$Fn43 = new ModuleMethod(lists, 48, (Object) null, 8194);
        cdaaar$Fn44 = new ModuleMethod(lists, 49, "cdaaar", 4097);
        lambda$Fn45 = new ModuleMethod(lists, 50, (Object) null, 8194);
        cdaadr$Fn46 = new ModuleMethod(lists, 51, "cdaadr", 4097);
        lambda$Fn47 = new ModuleMethod(lists, 52, (Object) null, 8194);
        cdadar$Fn48 = new ModuleMethod(lists, 53, "cdadar", 4097);
        lambda$Fn49 = new ModuleMethod(lists, 54, (Object) null, 8194);
        cdaddr$Fn50 = new ModuleMethod(lists, 55, "cdaddr", 4097);
        lambda$Fn51 = new ModuleMethod(lists, 56, (Object) null, 8194);
        cddaar$Fn52 = new ModuleMethod(lists, 57, "cddaar", 4097);
        lambda$Fn53 = new ModuleMethod(lists, 58, (Object) null, 8194);
        cddadr$Fn54 = new ModuleMethod(lists, 59, "cddadr", 4097);
        lambda$Fn55 = new ModuleMethod(lists, 60, (Object) null, 8194);
        cdddar$Fn56 = new ModuleMethod(lists, 61, "cdddar", 4097);
        lambda$Fn57 = new ModuleMethod(lists, 62, (Object) null, 8194);
        cddddr$Fn58 = new ModuleMethod(lists, 63, "cddddr", 4097);
        length = new ModuleMethod(lists, 64, Lit8, 4097);
        reverse = new ModuleMethod(lists, 65, Lit9, 4097);
        list$Mntail = new ModuleMethod(lists, 66, Lit10, 8194);
        list$Mnref = new ModuleMethod(lists, 67, Lit11, 8194);
        list$Qu = new ModuleMethod(lists, 68, Lit12, 4097);
        reverse$Ex = new ModuleMethod(lists, 69, Lit13, 4097);
    ...
    public int match2(ModuleMethod moduleMethod, Object obj, Object obj2, CallContext callContext) {
        switch (moduleMethod.selector) {
            ...
            case 67:
                ...
                callContext.f201pc = 2;
                return 0;
            case PrettyWriter.NEWLINE_FILL:
                callContext.value1 = obj;
                callContext.value2 = obj2;
                callContext.proc = moduleMethod;
                callContext.f201pc = 2;
            ...
            case 75:
                ...
                callContext.f201pc = 2;
                return 0;
            case PrettyWriter.NEWLINE_LITERAL:
                callContext.value1 = obj;
                callContext.value2 = obj2;
                callContext.proc = moduleMethod;
                callContext.f201pc = 2;
