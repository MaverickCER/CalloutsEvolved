...
public class define_syntax extends Syntax {
    ...
    public void scanForm(Pair st, ScopeExp defs, Translator tr) {
        ...
        if (!(name2 instanceof Symbol)) {
            ...
            Expression rule2 = new ApplyExp((Procedure) this.hygienic ? makeHygienic : makeNonHygienic, new Expression[]{new QuoteExp(name2), rule, ThisExp.makeGivingContext(defs)});
            ...
            if (decl.context instanceof ModuleExp) {
                ...
                if (tr.immediate) {
                    tr.formStack.addElement(new ApplyExp((Procedure) setCapturedScope, new Expression[]{new ReferenceExp(decl), new QuoteExp(defs)}));
                }
            }
        }
    }
