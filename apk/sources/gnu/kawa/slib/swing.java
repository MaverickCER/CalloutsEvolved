...
public class swing extends ModuleBody {
    ...
    static {
        ...
        make$Mnaction$Mnlistener = new ModuleMethod(swing, 1, Lit13, 4097);
        fill = new ModuleMethod(swing, 2, Lit14, 4097);
        draw = new ModuleMethod(swing, 3, Lit15, 4097);
        ...
        rotation = new ModuleMethod(swing, 10, Lit20, 4097);
