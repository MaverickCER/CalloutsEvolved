...
public class enums extends ModuleBody {
    ...
    static {
        ...
        define$Mnenum = Macro.make(simpleSymbol2, new ModuleMethod(enums, 1, (Object) null, 4097), $instance);
        $Prvt$$Pcdefine$Mnenum = Macro.make(Lit21, new ModuleMethod(enums, 2, (Object) null, 4097), $instance);
        $instance.run();
    }
    ...
    static LList mapNames(Symbol t$Mnname, LList e$Mnnames, int i) {
        if (C0214lists.isNull(e$Mnnames)) {
            return LList.Empty;
        }
        Object apply1 = C0214lists.car.apply1(e$Mnnames);
        try {
            Object makeFieldDesc = makeFieldDesc(t$Mnname, (Symbol) apply1, i);
            Object apply12 = C0214lists.cdr.apply1(e$Mnnames);
            try {
                return C0214lists.cons(makeFieldDesc, mapNames(t$Mnname, (LList) apply12, i + 1));
            } catch (ClassCastException e) {
