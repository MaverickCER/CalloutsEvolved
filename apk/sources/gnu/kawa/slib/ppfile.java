...
public class ppfile extends ModuleBody {
    ...
    static {
        ...
        ModuleMethod moduleMethod = new ModuleMethod(ppfile, 4, (Object) null, 4097);
    ...
    public class frame extends ModuleBody {
        ...
        public Object lambda1(Object port) {
            ...
            Object outport = C0214lists.isNull(this.optarg) ? ports.current$Mnoutput$Mnport.apply0() : C0214lists.car.apply1(this.optarg);
                            ...
                            try {
                                if (characters.isChar$Eq(ppfile.Lit0, (Char) c)) {
                                    ...
                                    try {
                                        ...
                                        C0204pp.prettyPrint(Scheme.applyToArgs.apply2(this.staticLink.filter, o), export);
                                        c = readchar.peekChar.apply1(this.port);
