...
public class srfi69 extends ModuleBody {
    ...
    static {
        ...
        hash$Mntable$Mnequivalence$Mnfunction = new ModuleMethod(srfi69, 9, Lit5, 4097);
        hash$Mntable$Mnhash$Mnfunction = new ModuleMethod(srfi69, 10, Lit6, 4097);
        ...
        ModuleMethod moduleMethod = new ModuleMethod(srfi69, 23, (Object) null, 4097);
        ...
        hash$Mntable$Mn$Gralist = new ModuleMethod(srfi69, 28, Lit15, 4097);
        hash$Mntable$Mncopy = new ModuleMethod(srfi69, 29, Lit16, 4097);
        ...
        moduleMethod2.setProperty("source-location", "/Users/ewpatton/Programming/mit/ai2-kawa/gnu/kawa/slib/srfi69.scm:183");
        lambda$Fn2 = moduleMethod2;
        hash$Mntable$Mnkeys = new ModuleMethod(srfi69, 32, Lit18, 4097);
        ModuleMethod moduleMethod3 = new ModuleMethod(srfi69, 33, (Object) null, 12291);
        moduleMethod3.setProperty("source-location", "/Users/ewpatton/Programming/mit/ai2-kawa/gnu/kawa/slib/srfi69.scm:186");
        lambda$Fn3 = moduleMethod3;
        hash$Mntable$Mnvalues = new ModuleMethod(srfi69, 34, Lit19, 4097);
        $instance.run();
    }
                ...
                try {
                    ...
                    while (arg0 != LList.Empty) {
                        try {
                            ...
                            hashTableUpdate$Ex$SlDefault(hash$Mntable, C0214lists.car.apply1(elem), lambda$Fn1, C0214lists.cdr.apply1(elem));
                            arg0 = arg02.getCdr();
    ...
    public static hashtable.HashTable alist$To$HashTable(Object obj, Object obj2, Object obj3) {
        ...
        objArr[0] = Lit0;
        try {
            objArr[1] = Integer.valueOf(C0214lists.length((LList) obj) * 2);
    ...
    static Pair lambda2(Object key, Object val, Object acc) {
        return C0214lists.cons(key, acc);
    }
    ...
    static Pair lambda3(Object key, Object val, Object acc) {
        return C0214lists.cons(val, acc);
    }
