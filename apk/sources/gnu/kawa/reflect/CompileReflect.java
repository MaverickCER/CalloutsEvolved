    ...
    public static Expression validateApplySlotGet(ApplyExp exp, InlineCalls visitor, Type required, Procedure proc) {
        ...
        if (isStatic) {
            ...
            if ("class".equals(name)) {
                ...
                ApplyExp applyExp = new ApplyExp(exp.getFunction(), new Expression[]{new QuoteExp(type), arg1});
        ...
        if (type instanceof ObjectType) {
            ...
            if (part != null) {
                ApplyExp exp2 = new ApplyExp(exp.getFunction(), new Expression[]{arg0, new QuoteExp(part)});
