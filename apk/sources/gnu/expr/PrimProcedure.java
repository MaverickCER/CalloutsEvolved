...
public class PrimProcedure extends MethodProc implements Inlineable {
    ...
    public int isApplicable(Type[] argTypes2) {
        ...
        if (app != -1 || this.method == null || (this.method.getModifiers() & DateTime.TIMEZONE_MASK) == 0 || nargs <= 0 || !(argTypes2[nargs - 1] instanceof ArrayType)) {
            return app;
        }
    ...
    private void compileArgs(Expression[] args, int startArg, Type thisType, Compilation comp) {
        ...
        if (variable && (this.method.getModifiers() & DateTime.TIMEZONE_MASK) != 0 && nargs > 0 && this.argTypes.length > 0) {
