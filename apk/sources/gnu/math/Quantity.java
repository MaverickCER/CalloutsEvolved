...
public abstract class Quantity extends Numeric {
    ...
    /* renamed from: re */
    public RealNum mo4859re() {
        return number().mo4859re();
    }

    /* renamed from: im */
    public RealNum mo4858im() {
        return number().mo4858im();
    }
    ...
    public double doubleValue() {
        return unit().doubleValue() * mo4859re().doubleValue();
    }

    public double doubleImagValue() {
        return unit().doubleValue() * mo4858im().doubleValue();
    }
