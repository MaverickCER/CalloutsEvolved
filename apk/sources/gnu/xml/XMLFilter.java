...
public class XMLFilter implements DocumentHandler, ContentHandler, SourceLocator, XConsumer, PositionConsumer {
    ...
    public int getLineNumber() {
        int line;
        if (this.f211in != null && (line = this.f211in.getLineNumber()) >= 0) {
            return line + 1;
        }
        return -1;
    }
    ...
    public int getColumnNumber() {
        int col;
        if (this.f211in == null || (col = this.f211in.getColumnNumber()) <= 0) {
            return -1;
        }
        return col;
    }
