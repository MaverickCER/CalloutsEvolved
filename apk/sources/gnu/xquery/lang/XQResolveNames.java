...
public class XQResolveNames extends ResolveNames {
    ...
    public Expression visitApplyExp(ApplyExp exp, Void ignored) {
            ...
            switch (code) {
                ...
                case XS_QNAME_BUILTIN /*-35*/:
                    ...
                    if (args[0] instanceof QuoteExp) {
                        ...
                        ApplyExp app2 = new ApplyExp(ClassType.make("gnu.xquery.util.QNameUtils").getDeclaredMethod("resolveQName", 3), new Expression[]{args[0], new QuoteExp(constructorNamespaces), new QuoteExp(this.parser.prologNamespaces)});
                        app2.setFlag(4);
                        return app2;
                    }
                ...
                case RESOLVE_PREFIX_BUILTIN /*-13*/:
                    ...
                    ApplyExp app3 = new ApplyExp((Procedure) new PrimProcedure(ClassType.make("gnu.xquery.util.QNameUtils").getDeclaredMethod("resolvePrefix", 3)), new Expression[]{args4[0], new QuoteExp(this.parser.constructorNamespaces), new QuoteExp(this.parser.prologNamespaces)});
                    app3.setFlag(4);
                    return app3;
                ...
                case DOC_BUILTIN /*-9*/:
                    ...
                    ApplyExp aexp = new ApplyExp(meth, new Expression[]{args6[0], getBaseUriExpr()});
                    if (code == -9) {
                ...
                case COLLECTION_BUILTIN /*-8*/:
                    ...
                    ApplyExp aexp2 = new ApplyExp(meth2, new Expression[]{args7.length > 0 ? args7[0] : QuoteExp.voidExp, getBaseUriExpr()});
        ...
        if (proc2 instanceof Type) {
            ...
            return new ApplyExp(XQParser.makeFunctionExp("gnu.xquery.util.CastAs", "castAs"), new Expression[]{exp.getFunction(), args9[0]});
        }
