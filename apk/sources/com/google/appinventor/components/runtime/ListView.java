...
public final class ListView extends AndroidViewComponent implements AdapterView.OnItemClickListener {
    ...
    public void onItemClick(android.widget.AdapterView<?> r3, android.view.View r4, int r5, long r6) {
        /*
            ...
            r2.selection = r1
            android.widget.ArrayAdapter<android.text.Spannable> r1 = r2.adapterCopy
    ...
    public void SelectionColor(int argb) {
        ...
        this.view.setSelector(new GradientDrawable(GradientDrawable.Orientation.TOP_BOTTOM, new int[]{argb, argb}));
    }
