                ...
                try {
                    ...
                    Twitter.this.handler.post(new Runnable() {
                        public void run() {
                            ...
                            for (Status status : C01436.this.replies) {
                ...
                try {
                    ...
                    Twitter.this.handler.post(new Runnable() {
                        public void run() {
                            ...
                            for (User user : C01457.this.friends) {
                ...
                try {
                    ...
                    Twitter.this.handler.post(new Runnable() {
                        public void run() {
                            ...
                            for (DirectMessage message : C01478.this.messages) {
                ...
                try {
                    ...
                    Twitter.this.handler.post(new Runnable() {
                        public void run() {
                            ...
                            for (Status message : C013312.this.messages) {
                ...
                try {
                    ...
                    Twitter.this.handler.post(new Runnable() {
                        public void run() {
                            ...
                            for (Status tweet : C013513.this.tweets) {
