...
public class Form extends Activity implements Component, ComponentContainer, HandlesEventDispatching, ViewTreeObserver.OnGlobalLayoutListener {
    ...
    public void TitleVisible(boolean show) {
        View v;
        if (show != this.showTitle && (v = (View) findViewById(16908310).getParent()) != null) {
            if (show) {
                v.setVisibility(0);
            } else {
                v.setVisibility(8);
