...
public class NxtColorSensor extends LegoMindstormsNxtSensor implements Deleteable {
    ...
    /* access modifiers changed from: private */
    public int previousColor = Component.COLOR_NONE;
    /* access modifiers changed from: private */
    ...
    static {
        mapColorToSensorType.put(Integer.valueOf(Component.COLOR_RED), 14);
        ...
        mapColorToSensorType.put(Integer.valueOf(Component.COLOR_NONE), 17);
        ...
        mapSensorValueToColor.put(4, Integer.valueOf(Component.COLOR_YELLOW));
        mapSensorValueToColor.put(5, Integer.valueOf(Component.COLOR_RED));
