...
; 1. Example: recognizing a specific list of phrases
;ToolTip, Say a number between 0 and 9 inclusive
;s := new SpeechRecognizer
;s.Recognize(["zero", "one", "this is my strategy action", "three", "four", "the five test", "six", "destiny target", "eight", "flaking right"])
;Text := s.Prompt()
;ToolTip, You said: %Text%


; 2. Example: recognizing any phrase
...
; 3. Example: custom behaviour upon phrase recognition
